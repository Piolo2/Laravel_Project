    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            @if($user->providerVerification)
                <div class="card mt-4 border-{{ $user->providerVerification->status === 'pending' ? 'warning' : 'secondary' }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p><strong>Name:</strong> {{ $user->providerVerification->first_name }}
                                    {{ $user->providerVerification->last_name }}</p>
                                <p><strong>Address:</strong> {{ $user->providerVerification->address }}</p>
                            </div>
                            <div class="col-md-6">
                                <h6 class="text-muted">Professional Info</h6>
                                <p><strong>Service Type:</strong> {{ $user->providerVerification->service_type ?? 'N/A' }}</p>
