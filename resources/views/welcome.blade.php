        ...
        <header class="w-100 mb-4" style="max-width: 900px;">
            @if (Route::has('login'))
                <nav class="d-flex justify-content-end gap-3">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-link btn-sm text-dark text-decoration-none">Log in</a>
        ...
        <main class="main-card">
            <div class="row g-0">
                <div class="col-lg-6 left-panel">
                    <h1 class="h4 fw-bold mb-2">Let's get started</h1>
                    <p class="text-muted mb-4">Laravel has an incredibly rich ecosystem. <br>We suggest starting with
                        the following.</p>

                    <div class="step-list mb-4">
                        <div class="step-item">
                            <div class="step-dot"></div>
                            <span>
                                Read the
                                <a href="https://laravel.com/docs" target="_blank"
                                    class="link-laravel">Documentation</a>
                            </span>
                        </div>
                        <div class="step-item">
                            <div class="step-dot"></div>
                            <span>
                                ...
                                <a href="https://laracasts.com" target="_blank" class="link-laravel">Laracasts</a>
                            </span>
                        </div>
                    </div>

                    <a href="https://cloud.laravel.com" target="_blank" class="btn-laravel d-inline-block">Deploy
                        now</a>
                </div>
                <div class="col-lg-6 right-panel">
                    <svg class="w-100" style="color: #F53003;" viewBox="0 0 438 104" fill="none"
